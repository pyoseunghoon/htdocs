...
session_start();
$kindC=$_SESSION["kind"];
$happenPlaceC=$_SESSION["place"];
$ageC=$_SESSION["age"];
$colorCdC=$_SESSION["color"];
$sexC=$_SESSION["sex"];
    $pageNo=1;
    $numOfRows=5000;
        ...
        <div class="row portfolio-container">
                            ...
                            if($object->body->totalCount !== 0 ){
						     ...
						     foreach($data->items->item as $store){
                                ...
                                $sex="암컷";
                                 if((strpos($kind,$kindC)!==false) && (strpos($happenPlace,$happenPlaceC)!==false)&&
                                   (strpos($kind,$kindC)!==false)&&
                                   (strpos($sex,$sexC)!==false)&&
                                   (strpos($colorCd,$colorCdC)!==false)){
